...
namespace CoffeeRoaster.UnitTests
{
    public class Ti430BoostAds1118ConnectionUnitTests
    {
        ...
        public void InitializeTest()
        {
            ...
            this.mockLcdResetGpio = new Mock<IOutputBinaryPin>();
            this.mockSpi0 = new Mock<INativeSpiConnection>();
            this.mockSpi1 = new Mock<INativeSpiConnection>();
        ...
        {
            // arrange
            var inputMode = Ads1118TemperatureSensorMode.ExternalSignal;
            var inputChannel = Ads1118InputMultiplexer.Ain0Ain1;
